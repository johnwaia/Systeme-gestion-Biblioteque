...
// Fabrique concrète pour les Livres
public class LivreFactory implements DocumentFactory {
    @Override
    public String getInsertQuery() {
        return "INSERT INTO livre (titre, auteur, genre, annee, fichier_pdf, client_id) VALUES (?, ?, ?, ?, ?, ?)";
    }
