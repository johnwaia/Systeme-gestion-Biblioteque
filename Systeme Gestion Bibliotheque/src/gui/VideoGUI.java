...
public class VideoGUI {
    ...
    public VideoGUI(Client client) {
        this.client = client;

        frame = new JFrame("Ajouter une Vidéo");
    ...
    private void ajouterVideo() {
        ...
        JOptionPane.showMessageDialog(frame, "Vidéo ajoutée avec succès!");
